...
//    private double calcuatedDensity;
    ...
    public TankDTO(String name, double capacity, double level, double volume, /*double correctedDensity, /*double correctionFactor, double correctionTemp, */
                   /*double currentTemperature,*/ double mass, double lowLevel, double hightLevel, double height, double redius, Permissions permission, String productID) {
        Name = name;
        Capacity = capacity;
        Level = level;
        Volume = volume;
...
//        this.currentTemperature = currentTemperature;
    ...
    public TankDTO(double capacity, double level, double volume, double correctedDensity, /*double correctionFactor, double correctionTemp,double currentTemperature,*/
                   double mass, double lowLevel, double hightLevel, double height, double redius, Permissions permission, String productID) {
        Capacity = capacity;
        Level = level;
        Volume = volume;
//        this.correctedDensity = correctedDensity;
