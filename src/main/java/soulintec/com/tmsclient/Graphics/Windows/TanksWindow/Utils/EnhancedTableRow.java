...
public class EnhancedTableRow extends TableRow<MainTanksWindow.TankTableObject> {
    ...
    @Override
    protected void updateItem(MainTanksWindow.TankTableObject item, boolean empty) {
