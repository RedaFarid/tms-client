...
public class EnhancedDoubleField extends TextField {
    private DoubleProperty doubleValue = new SimpleDoubleProperty(-1.0);
    ...
    public EnhancedDoubleField() {
        ...
        textProperty().addListener((observableValue, s, s1) -> {
            ...
            try {
                doubleValue.setValue(Double.parseDouble(getText()));
            } catch (Exception e) {
                Platform.runLater(() -> {
                    setText(String.valueOf(getDoubleValue()));
                });
            }
        });
...
//                            setBackground(new Background(new BackgroundFill(Color.LIGHTBLUE, CornerRadii.EMPTY, Insets.EMPTY)));
        ...
        doubleValue.addListener(new ChangeListener<Number>() {
            @Override
